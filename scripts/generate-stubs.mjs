...
const GITEE = 'https://gitee.com/yaogengzhu/docker-compose/tree/master'
...
description: ${cat.summary}。对照 ops-docs 与 yaogengzhu/docker-compose，按服务查看用途和源码目录。
keywords: Docker Compose, ${cat.name}, 一键部署
---

# ${cat.name}

${cat.summary}。标了「详解」的页面有完整讲解，其余先给用途和源码入口。
...
- [Gitee：${s.giteePath}](${GITEE}/${s.giteePath})
